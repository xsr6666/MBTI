...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "小狗身份证"
    }
  },
  {
    path: "pages/info/info",
    style: {
      navigationBarTitleText: "小狗身份证注册"
    }
  }
];
const e = {
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = b, T = I(""), C = I('[{"provider":"aliyun","spaceName":"cat","spaceId":"mp-403886dc-292a-492e-897c-401858c558ad","clientSecret":"a5QayMvxVtab6dDAXLwiJw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__A3FA345";
} catch (e2) {
